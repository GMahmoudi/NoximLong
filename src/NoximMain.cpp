...
bool NoximGlobalParams::long_connections_status = DEFAULT_LONG_CONNECTIONS_STATUS;
char NoximGlobalParams::long_connections_filename[128] = DEFAULT_LONG_CONNECTIONS_FILENAME;
