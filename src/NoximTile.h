...
SC_MODULE(NoximTile)
{
	...
	if (r== NULL) {cout<< "r is NULL!!!" <<endl;}
	else {cout << "r is not a NULL!!!" << endl;}
...
void before_end_of_elaboration() {
 //   cout << "NoximTile, size of clock port before end of elaboration: " << clock.size() << endl;
  //  cout << "NoximTile, size of reset port before end of elaboration: " << reset.size() << endl;
}

void end_of_elaboration() {
 //   cout << "NoximTile, size of clock port at the end of elaboration: " << clock.size() << endl;
}

void start_of_simulation() {
   // cout << "NoximTile, size of clock port at the start of simulation: " << clock.size() << endl;
}
*/
