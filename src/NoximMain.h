...
//-----------------------------
// Define the directions as numbers for 5 directions routers, i.e. routers with an additional long connection
#define DIRECTIONS_FIVE        5//Number of directions: it is 5 (the local direction is not considered in this number).
#define DIRECTION_LongConnection        4 //The direction of the long connections (the additional direction)
#define DIRECTION_LOCAL_For5DirectionsRouters 5 //The local direction
//-----------------------------


//Define number of 5_Directions tiles, must be an even number
#define MAX_NUMBER_OF_FIVE_DIRECTIONAL_TILES 20
//int IDsOfFiveDirectionsTiles[numberOf5DirectionsTiles];
...
#define ROUTING_XY_naiv5      10
#define ROUTING_XY_simple5    11
//#define ROUTING_FULLY_ADAPTIVE_5 12
...
//Long connections 
#define DEFAULT_LONG_CONNECTIONS_STATUS                false
#define DEFAULT_LONG_CONNECTIONS_FILENAME                 ""
#define Long_Connections_Activated			true
...
struct NoximGlobalParams {
    ...
    static char long_connections_filename[128];
    static bool long_connections_status;
};
